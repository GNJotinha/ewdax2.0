...
def render(df: pd.DataFrame, _USUARIOS: dict):
    ...
    with c1:
        ...
        st.markdown(
            "<span style='color:#9ca3af;font-size:0.85rem'>Dados atualizados • mês atual</span>",
    ...
    card(cols[0], "Ofertadas – UTR", _fmt_int(ofertadas),
         f"Absoluto {utr_abs:.2f} • Média {utr_med:.2f}")
