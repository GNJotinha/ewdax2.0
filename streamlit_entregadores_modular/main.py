...
if modo == "Lista de Ativos":
    ...
    # Filtros — Subpraça (com LIVRE) e Turno
    sub_opts = _sub_options_with_livre(df, praca_scope="SAO PAULO")
    ...
    df_sel = _apply_sub_filter(df_sel, filtro_sub, praca_scope="SAO PAULO")
    if filtro_turno:
        df_sel = df_sel[df_sel["periodo"].isin(filtro_turno)]

    # Define 'ativo': teve qualquer atividade (horas ou corridas)
    soma = (
